...
(function (global, factory) {
  ...
  function createPatchFunction (backend) {
    ...
    // 最开始都是从最外层元素开始，比如例子的<main id="app">
    // 逐层深入去比较
    function patchVnode (
      oldVnode,
      vnode,
      ...
      var log = function () {
        ...
        return console.log.apply(console, [ Date.now(), ("patchVnode-" + (rest.shift())) ].concat( rest ));
      };
      if (oldVnode === vnode) {
        return
      }
  ...
  function parseFilters (exp) {
    ...
    var log = function () {
      ...
      console.log.apply(console, [ 20191110, 'parseFilters', ++logCount ].concat( rest ));
    };
    var inSingle = false;
    var inDouble = false;
  ...
  console.log(Date.now(), 'modules:', modules);
